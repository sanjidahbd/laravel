    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Product Entry From</h4>
                                    ...
                                    <form method="post" action="{{route('product.store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="name" name="prod_name" value="{{old('prod_name')}}" placeholder="Product  Name">
                                                ...
                                                <input type="text" class="form-control" id="name" name="sku" value="{{old('sku')}}" >
                                                 <label for="name">Product Stock</label>
                                                <input type="numder" class="form-control" id="name" name="stock" value="{{old('stock')}}" >
                                                 <label for="name">Product Price</label>
                                                <input type="number" class="form-control" id="name" name="price" value="{{old('price')}}" >
